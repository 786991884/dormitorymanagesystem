...
<script type="text/javascript">
	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			url : '${pageContext.request.contextPath}/resourceAction!allTree.action',
			parentField : 'pid',
			//lines : true,
			checkbox : true,
		...
		$('#admin_roleGrant_form').form({
			url : '${pageContext.request.contextPath}/roleAction!grant.action',
			onSubmit : function() {
				$.messager.progress({
					title : '提示',
					text : '数据处理中，请稍后....'
...
<div id="roleGrantLayout" class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'west'" title="系统资源" style="width: 300px; padding: 1px;">
		<div class="well well-small">
			<form id="admin_roleGrant_form" method="post">
