...
<script type="text/javascript">
	$(function() {
		$('#admin_zygl_edit_iconCls').combobox({
			data : $.iconData,
		...
		$('#admin_zygl_editform').form({
			url : '${pageContext.request.contextPath}/resourceAction!edit.action',
			onSubmit : function() {
				$.messager.progress({
					title : '提示',
					text : '数据处理中，请稍后....'
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="admin_zygl_editform" method="post">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<th>上级资源</th>
					<td><select id="admin_zygl_edit_pid" name="pid" style="width: 140px; height: 29px;"></select><img src="${pageContext.request.contextPath}/style/images/extjs_icons/cut_red.png" onclick="$('#admin_zygl_edit_pid').combotree('clear');" /></td>
				</tr>
				<tr>
					<th>菜单图标</th>
					<td colspan="3"><input id="admin_zygl_edit_iconCls" name="iconCls" style="width: 375px; height: 29px;" data-options="editable:false" /></td>
				</tr>
				<tr>
					<th>备注</th>
					<td colspan="3"><textarea name="remark" rows="3" cols="60" class="span5">${resource.remark}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
